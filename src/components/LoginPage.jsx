...
const LoginPage = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!isLoginMode) {
        // ✨ 핵심 수정 부분: 백엔드가 요구하는 'username' 필드를 추가했습니다.
        console.log("회원가입 시도:", { email, password, username: name });
        await api.post('/auth/signup', {
          email: email,
          password: password,
          username: name  // <--- 이 줄이 반드시 있어야 'Field required' 에러가 안 납니다!
        });
